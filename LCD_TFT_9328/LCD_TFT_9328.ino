...
void setup()
{
    ...
    tft.begin(0x9329);//if Driver IC is ILI9329
 ...
 tft.setRotation(2);
 bmpDraw("test.bmp", 0, 0);//show a beautiful girl photo in the folder \libraries\MCUFRIEND_kbv\bitmaps
//   delay(1000);
 }
 ...
 void loop()
 {
  for(int i = 0; i<4; i++) {
    ...
    bmpDraw("01.bmp", 0, 0);delay(2000);
    bmpDraw("02.bmp", 0, 0);delay(2000);
    bmpDraw("03.bmp", 0, 0);delay(2000);
    bmpDraw("351.bmp", 0, 0);delay(2000);
    bmpDraw("352.bmp", 0, 0);delay(2000);
    bmpDraw("353.bmp", 0, 0);delay(2000);
    bmpDraw("test.bmp", 0, 0);delay(2000);
   }
