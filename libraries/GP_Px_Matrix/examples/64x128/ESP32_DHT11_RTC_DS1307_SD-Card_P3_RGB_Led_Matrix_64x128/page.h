...
function myFunctionchF() {
  var strLine = "changefont";
  var request = new XMLHttpRequest();
  request.open("GET", strLine, false);
  request.send(null);
  GetArduinodata();
}
function myFunctionchSa() {
  var strLine = "SttSave";
  var request = new XMLHttpRequest();
  request.open("GET", strLine, false);
  request.send(null);
...
function GetArduinodata() {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
            ...
            lfont      = this.responseXML.getElementsByTagName('analog')[3].childNodes[0].nodeValue;
            cival      = this.responseXML.getElementsByTagName('analog')[4].childNodes[0].nodeValue;
            amval      = this.responseXML.getElementsByTagName('analog')[5].childNodes[0].nodeValue;
    }
    ...
    document.getElementById("fontmesg").innerHTML = lang_font[lfont];
     ...
     <div class="data-input">
       <table>
         <form action="/" method="POST">
            ...
            <td style="width:15%">
                <button onclick="myFunctionchF()" class="button-blue" style="width:98%"><span id="fontmesg"></button></td>
            <td style="width:20%">
                <button onclick="myFunctionchSa()" class="button-blue" style="width:98%">Save</button></td>
         </form>
       </table>
     </div>
</tr>
    ...
    <tr>
        <table>
         <form action="/" method="POST">
            <td style="width:25%">
            <div class="data-input">
                <button class="button-blue" onclick="myFunctionMA()"><span id="ammesg"></span></button>
            </div></td>
            <td style="width:25%">
            <div class="data-input">
                <button class="button-blue" onclick="myFunctionMra()"><span id="cimesg"></span></button>
            </div></td>
            <td style="width:25%">
            <div class="data-input">
