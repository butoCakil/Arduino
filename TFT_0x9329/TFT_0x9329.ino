...
MCUFRIEND_kbv tft;
#define SD_CS 5  //SD card pin on your shield

//Adafruit_TFTLCD tft(LCD_CS, LCD_RS, LCD_WR, LCD_RD, A4);
...
void loop()
{
  bmpDraw("miniwoof.bmp", 0, 0);      //Calling the bmpDraw function ("Name_of_your_image.bmp",x,y) (x,y) is the starting position of the picture drawing
  delay(2000);
  bmpDraw("01.bmp", 0, 0);
  delay(2000);
  bmpDraw("02.bmp", 0, 0);
