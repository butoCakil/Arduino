...
//            int persenData = 99 - (data.length() - i);
//            int tambahPersenData;
            
//            if(k == 0){
//              if(persenData < 0){
//                tambahPersenData = persenData * (-1);
//                  persenData = 0;
//              } else {
//                tambahPersenData = 0;
//              }
...
//            k++;
//            persenData = persenData + tambahPersenData;
...
//          Serial.println(" %");
          ...
          Serial.println("Loading 100 % - Selesai.. ");
          j=0;
          k=0;
          break;
        }
