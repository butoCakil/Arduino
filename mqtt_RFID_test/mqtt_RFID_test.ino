...
const char* mqtt_server = "10.16.0.94";  // Ganti dengan alamat IP broker MQTT Anda
...
char nodevice[20] = "2309MAS002";      // Change to your desired Node Device (max 20 characters)
