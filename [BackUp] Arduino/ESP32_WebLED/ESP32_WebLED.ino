...
const char* ssid     = "ESEpro";     // Your wifi
const char* password = "sijitekanwolu"; // wifi password
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<body><h2>Youtube : Tech Wan</h2>");
            
            // Display current state, and ON/OFF buttons for GPIO 2  
            client.println("<p>Condition GPIO 2 - State " + output2State + "</p>");
            ...
            client.println("<p>Condition GPIO 4 - State " + output4State + "</p>");
            ...
            client.println("<p>Condition GPIO 33 - State " + output33State + "</p>");
            ...
            client.println("<p>Condition GPIO 32 - State " + output32State + "</p>");
            // If the output33State is off, it displays the ON button       
